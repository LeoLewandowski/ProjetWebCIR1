...
--
-- Hôte : 127.0.0.1
<<<<<<< Updated upstream:octimeDB.sql
-- Généré le : sam. 27 avr. 2024 à 11:57
=======
-- Généré le : dim. 28 avr. 2024 à 16:45
>>>>>>> Stashed changes:octimeBD.sql
...
('Octime Swift II', 'Faite pour les coureurs et les pilotes, cette montre vous accompagnera dans chaque voyage que vous ferez, que ce soit sous les mers ou sur la Lune', 'Made for runners and pilots, this watch will follow you on any trip you can make, however it is on the Moon or beyond the seas', 'D', 'M', 1500, 3),
